  ...
  get$positionalArguments$bailout: function(state0, t1, list, t3, argumentCount) {
    switch (state0) {
      ...
      case 2:
        var index;
        state0 = 0;
        for (index = 0; $.CONSTANT5.$lt(index, argumentCount); ++index)
  ...
  get$namedArguments$bailout: function(state0, t1, map, t3, namedArgumentCount, t5, t7, namedArgumentsStartIndex) {
    switch (state0) {
      ...
      case 4:
        var t2, i;
        state0 = 0;
        for (t2 = $.getInterceptor$JSNumber(namedArgumentsStartIndex), i = 0; $.CONSTANT5.$lt(i, namedArgumentCount); ++i)
...
$$.Object = {"": ";",
  ...
  removeLayer$1: function($0) {
    return this.noSuchMethod$1($.createInvocationMirror("removeLayer", "removeLayer$1", 0, [$0], []));
  },
  ...
  get$latitude: function() {
    return this.noSuchMethod$1($.createInvocationMirror("latitude", "get$latitude", 1, [], []));
  },
  get$_values: function() {
    return this.noSuchMethod$1($.createInvocationMirror("_values", "get$_values", 1, [], []));
  },
  get$lng: function() {
    return this.noSuchMethod$1($.createInvocationMirror("lng", "get$lng", 1, [], []));
  },
  get$longitude: function() {
    return this.noSuchMethod$1($.createInvocationMirror("longitude", "get$longitude", 1, [], []));
  },
  get$$$dom_attributes: function() {
    return this.noSuchMethod$1($.createInvocationMirror("$dom_attributes", "get$$$dom_attributes", 1, [], []));
  },
  get$open: function() {
    return this.noSuchMethod$1($.createInvocationMirror("open", "get$open", 1, [], []));
  },
  ...
  get$_featureLayerGroup: function() {
    return this.noSuchMethod$1($.createInvocationMirror("_featureLayerGroup", "get$_featureLayerGroup", 1, [], []));
  },
  get$_set: function() {
    return this.noSuchMethod$1($.createInvocationMirror("_set", "get$_set", 1, [], []));
  },
  get$Point: function() {
    return this.noSuchMethod$1($.createInvocationMirror("Point", "get$Point", 1, [], []));
  },
  get$_mapFeature: function() {
    return this.noSuchMethod$1($.createInvocationMirror("_mapFeature", "get$_mapFeature", 1, [], []));
  },
  get$Popup: function() {
    return this.noSuchMethod$1($.createInvocationMirror("Popup", "get$Popup", 1, [], []));
  },
  get$isCaseSensitive: function() {
  ...
  get$_liblib4$_map: function() {
    return this.noSuchMethod$1($.createInvocationMirror("_map", "get$_liblib4$_map", 1, [], []));
  },
  get$iterator: function() {
    return this.noSuchMethod$1($.createInvocationMirror("iterator", "get$iterator", 1, [], []));
  },
  get$MousePosition: function() {
    return this.noSuchMethod$1($.createInvocationMirror("MousePosition", "get$MousePosition", 1, [], []));
  },
  get$cause: function() {
  ...
  get$_popup: function() {
    return this.noSuchMethod$1($.createInvocationMirror("_popup", "get$_popup", 1, [], []));
  },
  get$TileLayer: function() {
    return this.noSuchMethod$1($.createInvocationMirror("TileLayer", "get$TileLayer", 1, [], []));
  },
  get$lat: function() {
    return this.noSuchMethod$1($.createInvocationMirror("lat", "get$lat", 1, [], []));
  },
  get$initialLon: function() {
    return this.noSuchMethod$1($.createInvocationMirror("initialLon", "get$initialLon", 1, [], []));
  },
  ...
  get$close: function() {
    return this.noSuchMethod$1($.createInvocationMirror("close", "get$close", 1, [], []));
  },
  get$_next: function() {
  ...
  get$LatLng: function() {
    return this.noSuchMethod$1($.createInvocationMirror("LatLng", "get$LatLng", 1, [], []));
  },
  ...
  get$initialZoom: function() {
    return this.noSuchMethod$1($.createInvocationMirror("initialZoom", "get$initialZoom", 1, [], []));
  },
  ...
  get$Icon: function() {
    return this.noSuchMethod$1($.createInvocationMirror("Icon", "get$Icon", 1, [], []));
  },
  ...
  get$animatedPolygon: function() {
    return this.noSuchMethod$1($.createInvocationMirror("animatedPolygon", "get$animatedPolygon", 1, [], []));
  },
  ...
  get$Map: function() {
    return this.noSuchMethod$1($.createInvocationMirror("Map", "get$Map", 1, [], []));
  },
  get$$$dom_localName: function() {
    return this.noSuchMethod$1($.createInvocationMirror("$dom_localName", "get$$$dom_localName", 1, [], []));
  },
  get$L: function() {
    return this.noSuchMethod$1($.createInvocationMirror("L", "get$L", 1, [], []));
  },
  ...
  get$moveendHandler: function() {
    return this.noSuchMethod$1($.createInvocationMirror("moveendHandler", "get$moveendHandler", 1, [], []));
  },
  get$style: function() {
  ...
  get$imageURL: function() {
    return this.noSuchMethod$1($.createInvocationMirror("imageURL", "get$imageURL", 1, [], []));
  },
  get$dimension: function() {
    return this.noSuchMethod$1($.createInvocationMirror("dimension", "get$dimension", 1, [], []));
  },
  get$Marker: function() {
    return this.noSuchMethod$1($.createInvocationMirror("Marker", "get$Marker", 1, [], []));
  },
  get$CircleMarker: function() {
    return this.noSuchMethod$1($.createInvocationMirror("CircleMarker", "get$CircleMarker", 1, [], []));
  },
  ...
  get$LayerGroup: function() {
    return this.noSuchMethod$1($.createInvocationMirror("LayerGroup", "get$LayerGroup", 1, [], []));
  },
  get$ports: function() {
    return this.noSuchMethod$1($.createInvocationMirror("ports", "get$ports", 1, [], []));
  },
  get$Control: function() {
    return this.noSuchMethod$1($.createInvocationMirror("Control", "get$Control", 1, [], []));
  },
  get$_tag: function() {
  ...
  get$Polyline: function() {
    return this.noSuchMethod$1($.createInvocationMirror("Polyline", "get$Polyline", 1, [], []));
  },
  get$initialLat: function() {
    return this.noSuchMethod$1($.createInvocationMirror("initialLat", "get$initialLat", 1, [], []));
  },
  get$_workerId: function() {
    return this.noSuchMethod$1($.createInvocationMirror("_workerId", "get$_workerId", 1, [], []));
  },
  get$_elementid: function() {
    return this.noSuchMethod$1($.createInvocationMirror("_elementid", "get$_elementid", 1, [], []));
  },
  get$listener: function() {
    return this.noSuchMethod$1($.createInvocationMirror("listener", "get$listener", 1, [], []));
  },
  set$_mapFeature: function($0) {
    return this.noSuchMethod$1($.createInvocationMirror("_mapFeature=", "set$_mapFeature", 2, [$0], []));
  },
  set$_liblib4$_map: function($0) {
    return this.noSuchMethod$1($.createInvocationMirror("_map=", "set$_liblib4$_map", 2, [$0], []));
  },
  ...
  set$_zoom: function($0) {
    return this.noSuchMethod$1($.createInvocationMirror("_zoom=", "set$_zoom", 2, [$0], []));
  },
  set$text: function($0) {
  ...
  set$_featureLayerGroup: function($0) {
    return this.noSuchMethod$1($.createInvocationMirror("_featureLayerGroup=", "set$_featureLayerGroup", 2, [$0], []));
  },
  set$type: function($0) {
    return this.noSuchMethod$1($.createInvocationMirror("type=", "set$type", 2, [$0], []));
  },
  set$_popup: function($0) {
    return this.noSuchMethod$1($.createInvocationMirror("_popup=", "set$_popup", 2, [$0], []));
  }
};
            ...
            switch (state0) {
              ...
              case 3:
                ...
                if (existingKey == null) {
                  ...
                  return hash;
                else if ($.$$lt(insertionIndex, 0) === true && existingKey === $.CONSTANT)
                  insertionIndex = hash;
                numberOfProbes0 = numberOfProbes + 1;
                hash = $._HashMapImpl__nextProbe(hash, numberOfProbes, $.length(this._keys));
              case 4:
  ...
  _grow$1$bailout: function(state0, newCapacity, capacity, oldKeys, oldValues) {
    switch (state0) {
      ...
      case 3:
        ...
        $.setRuntimeTypeInfo(t4, [$.getRuntimeTypeInfo(this)[1]]);
        this._values = t4;
        for (t1 = $.getInterceptor$JSArrayJSString(oldKeys), t2 = $.getInterceptor$JSArrayJSString(oldValues), i = 0; $.CONSTANT5.$lt(i, capacity); ++i) {
...
$$._LinkedHashMapImpl = {"": "Object;_liblib1$_list,_map",
  $indexSet: function(key, value) {
    ...
    if (this._map.containsKey$1(key) === true) {
      ...
      $.addLast(this._liblib1$_list, $._KeyValuePair$(key, value));
      t1 = this._map;
  ...
  forEach$1: function(f) {
    $.forEach(this._liblib1$_list, new $._LinkedHashMapImpl_forEach_anon(f));
  },
  containsKey$1: function(key) {
...
$$._HashSetIterator = {"": "Object;_keysIterator",
  ...
  moveNext$0: function() {
    ...
    do {
      ...
      if (result === true)
        t2 = t1.get$current() == null || t1.get$current() === $.CONSTANT;
      else
        t2 = false;
    } while (t2);
    return result;
...
$$.MappedListIterable = {"": "Iterable;_list,_start,_end,_f",
  ...
  toList$0: function() {
    ...
    this.forEach$1($.CONSTANT3.get$add(result));
    return result;
  },
...
$$.MappedListIterator = {"": "Object;_list,_f,_endIndex,_liblib0$_length,_liblib0$_index,_liblib0$_current",
  _f$1: function(arg0) {
    return this._f.call$1(arg0);
  },
  get$current: function() {
...
$$.ListBase = {"": "Collection;",
  ...
  mappedBy$1: function(f) {
    return $.MappedList$(this, f, null, null);
  },
  toString$0: function() {
    return $.ToString_collectionToString(this);
  },
...
$$.ReceivePortImpl = {"": "Object;_liblib5$_id>,_liblib5$_callback>",
  ...
  close$0: function() {
    ...
    $globalState.currentContext.unregister$1(this._liblib5$_id);
  },
  get$close: function() {
...
$$._JsSerializer0 = {"": "_Serializer;_liblib5$_nextFreeRefId,_liblib5$_visited",
  ...
  visitNativeJsSendPort$1: function(port) {
    return ["sendport", $globalState.currentManagerId, port._liblib5$_isolateId, port._liblib5$_receivePort.get$_liblib5$_id()];
  },
...
$$._Copier = {"": "_MessageTraverser;",
  ...
  visitList$1: function(list) {
    ...
    copy = $.$$index(this._liblib5$_visited, list);
    if (!(copy == null))
      return copy;
    len = list.length;
...
$$._Serializer = {"": "_MessageTraverser;",
  ...
  visitList$1: function(list) {
    var copyId, id;
    copyId = $.$$index(this._liblib5$_visited, list);
    if (!(copyId == null))
      return ["ref", copyId];
  ...
  visitMap$1: function(map) {
    var copyId, id;
    copyId = $.$$index(this._liblib5$_visited, map);
    if (!(copyId == null))
      return ["ref", copyId];
    id = this._liblib5$_nextFreeRefId;
    this._liblib5$_nextFreeRefId = id + 1;
...
$$._Deserializer = {"": "Object;",
  deserialize$1: function(x) {
    if (x == null || typeof x === "string" || typeof x === "number" || typeof x === "boolean")
      return x;
    this._liblib5$_deserialized = $._HashMapImpl$(null, null);
  ...
  _liblib5$_deserializeRef$1: function(x) {
    var id = $.$$index(x, 1);
    return $.$$index(this._liblib5$_deserialized, id);
  },
  ...
  _liblib5$_deserializeMap$1: function(x) {
    ...
    if (typeof keys !== "string" && (typeof keys !== "object" || keys === null || keys.constructor !== Array && !keys.$isJavaScriptIndexingBehavior()))
      return this._liblib5$_deserializeMap$1$bailout(1, x, result, keys, t3);
    values = t3.$index(x, 3);
    ...
    for (i = 0; i < len; ++i) {
      ...
      if (i >= values.length)
        throw $.ioore(i);
      result.$indexSet(key, this._liblib5$_deserializeHelper$1(values[i]));
    }
    return result;
  },
  _liblib5$_deserializeMap$1$bailout: function(state0, x, result, keys, t3, values, t5, len) {
    switch (state0) {
      case 0:
        t1 = null;
        t2 = null;
      ...
      case 3:
        ...
        for (t1 = $.getInterceptor$JSArrayJSString(values), i = 0; $.CONSTANT5.$lt(i, len); ++i)
          result.$indexSet(this._liblib5$_deserializeHelper$1(t5.$index(keys, i)), this._liblib5$_deserializeHelper$1(t1.$index(values, i)));
        return result;
    }
  },
...
$$.TimerImpl = {"": "Object;_once,_inEventLoop,_handle<",
  TimerImpl$2: function(milliseconds, callback) {
    ...
    if ($.$$eq(milliseconds, 0) === true)
      ...
      t1 = false;
    if (t1) {
      $._globalState0().get$topEventLoop().enqueue$3($._globalState0().get$currentContext(), new $.anon5(this, callback), "timer");
...
$$._Serializer0 = {"": "_MessageTraverser0;",
  ...
  _serializeList$1: function(list) {
    ...
    len = list.length;
    result = $.List_List$fixedLength(len, null, null);
    $.setRuntimeTypeInfo(result, []);
    for (i = 0; i < len; ++i) {
      if (i >= list.length)
        throw $.ioore(i);
...
$$.JsonParser = {"": "Object;source>,listener>",
  ...
  parseTrue$1: function(position) {
    ...
    if (typeof t3 !== "number")
      return this.parseTrue$1$bailout(3, position, t2, t1, $.CONSTANT1, t3);
    if (t3 === 114) {
      t3 = t2.charCodeAt$1(t1, position + 2);
      if (typeof t3 !== "number")
        return this.parseTrue$1$bailout(4, position, t2, t1, $.CONSTANT1, t3);
      if (t3 === 117) {
        t1 = t2.charCodeAt$1(t1, position + 3);
        if (typeof t1 !== "number")
          return this.parseTrue$1$bailout(5, position, 0, t1, $.CONSTANT1);
        t3 = !(t1 === 101);
        t1 = t3;
      } else
        t1 = true;
  ...
  parseFalse$1: function(position) {
    ...
    t3 = t2.charCodeAt$1(t1, position + 1);
    if (typeof t3 !== "number")
      return this.parseFalse$1$bailout(3, position, t1, t2, $.CONSTANT1, t3);
    if (t3 === 97) {
      t3 = t2.charCodeAt$1(t1, position + 2);
      if (typeof t3 !== "number")
        return this.parseFalse$1$bailout(4, position, t1, t2, $.CONSTANT1, t3);
      if (t3 === 108) {
        t3 = t2.charCodeAt$1(t1, position + 3);
        if (typeof t3 !== "number")
          return this.parseFalse$1$bailout(5, position, t1, t2, $.CONSTANT1, t3);
        if (t3 === 115) {
          t1 = t2.charCodeAt$1(t1, position + 4);
          if (typeof t1 !== "number")
            return this.parseFalse$1$bailout(6, position, t1, 0, $.CONSTANT1);
          t3 = !(t1 === 101);
          t1 = t3;
        } else
          t1 = true;
  ...
  parseNull$1: function(position) {
    ...
    t3 = t2.charCodeAt$1(t1, position + 1);
    if (typeof t3 !== "number")
      return this.parseNull$1$bailout(3, position, t1, t2, $.CONSTANT1, t3);
    if (t3 === 117) {
      t3 = t2.charCodeAt$1(t1, position + 2);
      if (typeof t3 !== "number")
        return this.parseNull$1$bailout(4, position, t1, t2, $.CONSTANT1, t3);
      if (t3 === 108) {
        t1 = t2.charCodeAt$1(t1, position + 3);
        if (typeof t1 !== "number")
          return this.parseNull$1$bailout(5, position, t1, 0, $.CONSTANT1);
        t3 = !(t1 === 108);
        t1 = t3;
      } else
        t1 = true;
  ...
  parseNumber$2: function($char, position) {
    ...
    if ($char === 101 || $char === 69) {
      ...
      if (typeof $char !== "number")
        return this.parseNumber$2$bailout(7, $char, position, $.CONSTANT1, t2, $length, 0, t3, t1);
      if ($char === 43 || $char === 45) {
        ++position;
        if (position === $length)
          this.fail$2(position, "Missing expected digit");
...
$$.LeafletMap = {"": "Object;_elementid>,_liblib4$_map=,_featureLayerGroup=,_popup=,_zoom<",
...
$$.OpenStreetMap = {"": "LeafletMap;initialZoom>,initialLat>,initialLon>,_elementid,_width,_height,_liblib4$_map,_featureLayerGroup,_popup,_zoom",
  loadMap$0: function() {
  ...
  changeRegistration$0: function() {
    var zoom, boundsArray, t1, bounds, t2, t3, message;
    zoom = this.getZoom$0();
    if ($.$$lt(zoom, 3) === true) {
      this.zoomTo$1(3);
      return;
    }
    boundsArray = this.getBounds$0();
    t1 = $.getInterceptor$JSArrayJSString(boundsArray);
    bounds = $.makeLiteralMap(["_southWest", $.makeLiteralMap(["lat", t1.$index(boundsArray, 0), "lng", t1.$index(boundsArray, 1)]), "_northEast", $.makeLiteralMap(["lat", t1.$index(boundsArray, 2), "lng", t1.$index(boundsArray, 3)])]);
    t2 = null;
    t3 = null;
    message = $._HashMapImpl$(t2, t3);
    message.$indexSet("function", "register");
    message.$indexSet("zoom", zoom);
    message.$indexSet("bounds", bounds);
    $.timeFlex = $.DateTime$_now().millisecondsSinceEpoch;
    $.socket.send$1($._JsonStringifier_stringify(message));
  },
  getBounds$0: function() {
    var t1 = {};
    t1.south_0 = null;
  ...
  zoomTo$1: function(zoom) {
    $.scoped(new $.OpenStreetMap_zoomTo_anon(this, zoom));
  },
  clearFeatureLayer$0: function() {
  ...
  OpenStreetMap$4$height$width: function(elementid, mapOptions, height, width) {
    var t1 = $.getInterceptor$JSArrayJSString(mapOptions);
    this.initialZoom = t1.$index(mapOptions, 1);
    this.initialLat = t1.$index(mapOptions, 0).get$latitude();
    this.initialLon = t1.$index(mapOptions, 0).get$longitude();
  }
};
...
$$.Popup = {"": "Object;_popup=",
  ...
  Popup$3: function(popupOrigin, $content, options) {
    $.scoped(new $.anon4(this, popupOrigin, $content, options));
  }
};
...
$$.MapFeature = {"": "Object;_mapFeature=",
  addListeners$1: function(mmsi) {
    ...
    this._mapFeature.on$2("click", $.Callback$many(t1));
    this._mapFeature.on$2("mouseover", $.Callback$many(t3));
    this._mapFeature.on$2("mouseout", $.Callback$many(t2));
  },
  addTo$2: function(map, featureLayer) {
    $.scoped(new $.MapFeature_addTo_anon(this, map, featureLayer));
  },
  remove$2: function(map, featureLayer) {
    $.scoped(new $.MapFeature_remove_anon(this, map, featureLayer));
  }
};
...
$$.AnimatedPolygon = {"": "MapFeature;_mapFeature",
  ...
  AnimatedPolygon$3: function(vectorPoints, options, vmmsi) {
    $.scoped(new $.anon2(this, vectorPoints, options, vmmsi));
  }
};
...
$$.CircleMarker = {"": "MapFeature;_mapFeature",
  ...
  CircleMarker$3: function(vectorPoint, options, vMmsi) {
    $.scoped(new $.anon1(this, vectorPoint, options, vMmsi));
  }
};

$$.Marker = {"": "MapFeature;_mapFeature",
  addTo$2: function(map, featureLayer) {
    $.scoped(new $.Marker_addTo_anon(this, map, featureLayer));
  },
  setIcon$1: function(icon) {
    $.scoped(new $.Marker_setIcon_anon(this, icon));
  },
  Marker$4: function(latitude, longitude, tooltip, draggable) {
    $.scoped(new $.anon0(this, latitude, longitude, tooltip, draggable));
  }
};
...
$$.Callback = {"": "Object;_manualDispose,_liblib3$_id,_liblib3$_callback",
  ...
  _initialize$1: function(manualDispose) {
    ...
    this._liblib3$_id = $.add($.get$_proxiedObjectTable(), this._liblib3$_callback);
    $.get$_proxiedObjectTable().globalize$1(this._liblib3$_id);
  },
  Callback$many$1: function(f) {
    this._liblib3$_callback = f;
...
$$._ProxiedObjectTable = {"": "Object;_name,_nextId,_deletedCount,_registry>,_port,_globalIds,_handleStack,_scopeIndices>",
  enterScope$0: function() {
    $.CONSTANT3.addLast$1(this._scopeIndices, this._handleStack.length);
  },
  exitScope$0: function() {
    ...
    $.CONSTANT3.removeRange$2(t2, start, t5 - start);
  },
  exitScope$0$bailout: function(state0, start) {
    ...
    if (typeof start !== "number")
      throw $.iae(start);
    $.CONSTANT3.removeRange$2(t2, start, t6 - start);
  },
  ...
  add$1: function(x) {
    ...
    $.CONSTANT3.addLast$1(this._handleStack, id);
    return id;
  },
  ...
  call$1: function(e) {
    ...
    if (typeof e === "object" && e !== null && (e.constructor === Array || e.$isList())) {
        ...
        for (i = 0; i < $length; ++i) {
          ...
          if (!(elementCopy == null ? element == null : elementCopy === element)) {
            ...
            if (typeof copy0 !== "object" || copy0 === null || (copy0.constructor !== Array || !!copy0.immutable$list) && !copy0.$isJavaScriptIndexingBehavior())
              return this.call$1$bailout(3, e, $length, $.CONSTANT3, t3, elementCopy, copy0, slot, t2, i, copy);
      ...
      if (typeof copy !== "object" || copy === null || (copy.constructor !== Array || !!copy.immutable$list) && !copy.$isJavaScriptIndexingBehavior())
        return this.call$1$bailout(4, e, $length, $.CONSTANT3, 0, 0, 0, 0, 0, i, copy);
      for (; i < $length; ++i) {
        if (i >= e.length)
          throw $.ioore(i);
        t1 = this.call$1(e[i]);
...
$$.initWebSocket_anon = {"": "Closure;",
  call$1: function(e) {
    window.get$console().log$1("Connected to Websocket-Server");
    $.initMap();
  }
};

$$.initWebSocket_anon0 = {"": "Closure;retrySeconds_0",
  call$1: function(evt) {
    var t1, t2, t3;
    t1 = this.retrySeconds_0;
    t2 = "web socket closed, retrying in " + $.S(t1) + " seconds";
    window.get$console().log$1(t2);
    if ($.encounteredError !== true) {
      $.leaflet_map.close$0();
      t2 = window;
      t3 = new $.initWebSocket__anon0(t1);
      if (typeof t1 !== "number")
        throw $.iae(t1);
      t2.setTimeout$2(t3, 1000 * t1);
    }
    $.encounteredError = true;
  }
};

$$.initWebSocket__anon0 = {"": "Closure;retrySeconds_1",
  call$0: function() {
    return $.initWebSocket(this.retrySeconds_1);
  }
};

$$.initWebSocket_anon1 = {"": "Closure;",
  call$1: function(evt) {
    var timeQuery, json, t1, t2;
    timeQuery = $.$$sub($.DateTime$_now().millisecondsSinceEpoch, $.timeFlex);
    json = $.parse(evt.get$data(), null);
    t1 = $.getInterceptor$JSArrayJSString(json);
    if ($.$$eq(t1.$index(json, "type"), "vesselsInBoundsEvent") === true) {
      t2 = "BoundsEvent: " + $.S($.leaflet_map.getZoom$0()) + " " + $.S($.length(t1.$index(json, "vessels"))) + " " + $.S(timeQuery);
      window.get$console().log$1(t2);
...
$$.initWebSocket_anon2 = {"": "Closure;retrySeconds_2",
  call$1: function(evt) {
    var t1, t2, t3;
    t1 = "Error connecting to ws " + $.S($.toString(evt));
    window.get$console().log$1(t1);
    if ($.encounteredError !== true) {
      t1 = window;
      t2 = this.retrySeconds_2;
      t3 = new $.initWebSocket__anon(t2);
      if (typeof t2 !== "number")
        throw $.iae(t2);
      t1.setTimeout$2(t3, 1000 * t2);
    }
    $.encounteredError = true;
  }
};

$$.initWebSocket__anon = {"": "Closure;retrySeconds_3",
  call$0: function() {
...
$$.processVesselPositionEvent_anon = {"": "Closure;json_0",
  call$1: function(vesselWithMapObjects) {
    $.$$indexSet($.get$vessels(), $.toString($.$$index(this.json_0, "userid")), vesselWithMapObjects);
    if ($.$$gt($.leaflet_map.getZoom$0(), 12) === true) {
      if (vesselWithMapObjects.containsKey$1("triangle") === true)
        $.$$index(vesselWithMapObjects, "triangle").startAnimation$0();
      if (vesselWithMapObjects.containsKey$1("polygon") === true)
        $.$$index(vesselWithMapObjects, "polygon").startAnimation$0();
    }
    $.DateTime$_now().millisecondsSinceEpoch;
  }
};
...
$$.Marker_setIcon_anon = {"": "Closure;this_0,icon_1",
  call$0: function() {
    ...
    js_icon = $.Proxy_Proxy($.context().get$L().get$Icon(), $.Proxy_Proxy$_json($.makeLiteralMap(["iconUrl", t2.get$imageURL(), "iconSize", size])), $, $, $);
...
$$.Marker_addTo_anon = {"": "Closure;this_0,map_1,featureLayer_2",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.featureLayer_2;
    t2 = this.map_1;
    t3 = this.this_0;
    if (t1 === true)
...
$$.anon0 = {"": "Closure;this_0,latitude_1,longitude_2,tooltip_3,draggable_4",
  call$0: function() {
    var pos, t1, t2, options;
    pos = $.Proxy_Proxy($.context().get$L().get$LatLng(), this.latitude_1, this.longitude_2, $, $);
    t1 = null;
    t2 = null;
    options = $._HashMapImpl$(t1, t2);
    t1 = this.tooltip_3;
    if (!(t1 == null))
      options.$indexSet("title", t1);
    t1 = this.draggable_4;
    if (!(t1 == null))
      options.$indexSet("draggable", t1);
    t1 = $.Proxy_Proxy($.context().get$L().get$Marker(), pos, $.Proxy_Proxy$_json(options), $, $);
    t2 = this.this_0;
    t2.set$_mapFeature(t1);
    t2 = t2.get$_mapFeature();
    $._jsGlobalize.callSync$1($._serialize(t2));
  }
};
...
$$.anon1 = {"": "Closure;this_0,vectorPoint_1,options_2,vMmsi_3",
  call$0: function() {
    ...
    t3.addListeners$1(this.vMmsi_3);
    t3 = t3.get$_mapFeature();
    $._jsGlobalize.callSync$1($._serialize(t3));
  }
};
...
$$.MapFeature_addListeners_onClickHandler = {"": "Closure;mmsi_0",
  call$1: function(e) {
    var t1 = this.mmsi_0;
    $.Primitives_printString("clickEvent on " + $.S(e.get$type()) + " for ship " + $.S(t1));
    return;
  }
};
...
$$.anon2 = {"": "Closure;this_0,vectorPoints_1,options_2,vmmsi_3",
  call$0: function() {
    var latlng, points, t1, x, t2, triangleOptions;
    latlng = $.context().get$L().get$LatLng();
    points = $.Proxy_Proxy$_json([]);
  ...
  call$0$bailout: function(state0, points, t1, latlng) {
    var t3, x, triangleOptions, t2;
    t3 = $.getInterceptor$JSArrayJSString(t1);
    x = 0;
    for (; $.CONSTANT5.$lt(x, t3.get$length(t1)); ++x)
      points.push$1($.Proxy_Proxy(latlng, t3.$index(t1, x).get$latitude(), t3.$index(t1, x).get$longitude(), $, $));
    triangleOptions = $.Proxy_Proxy$_json(this.options_2);
    t1 = $.Proxy_Proxy($.context().get$L().get$animatedPolygon(), points, triangleOptions, $, $);
    t2 = this.this_0;
    t2.set$_mapFeature(t1);
...
$$.processVesselsInBounds_anon = {"": "Closure;",
  call$2: function(k, v) {
    var t1 = $.getInterceptor$JSArrayJSString(v);
    if (!(t1.$index(v, "polygon") == null))
      t1.$index(v, "polygon").stopAnimation$0();
    if (!(t1.$index(v, "triangle") == null))
      t1.$index(v, "triangle").stopAnimation$0();
  }
};
...
$$.processVesselsInBounds_anon0 = {"": "Closure;currentZoom_0,x_1",
  call$1: function(vesselWithMapObjects) {
    ...
    if ($.$$gt(this.currentZoom_0, 12) === true) {
      t1 = $.getInterceptor$JSArrayJSString(vesselWithMapObjects);
      if (!(t1.$index(vesselWithMapObjects, "triangle") == null))
        t1.$index(vesselWithMapObjects, "triangle").startAnimation$0();
      if (!(t1.$index(vesselWithMapObjects, "polygon") == null))
        t1.$index(vesselWithMapObjects, "polygon").startAnimation$0();
    }
    $.DateTime$_now().millisecondsSinceEpoch;
  }
};

$$.anon4 = {"": "Closure;this_0,popupOrigin_1,content_2,options_3",
  call$0: function() {
    var popupOptions, t1, offsetPoint, latlng, t2, origin, t3;
    popupOptions = this.options_3;
    t1 = $.getInterceptor$JSArrayJSString(popupOptions);
    offsetPoint = $.Proxy_Proxy($.context().get$L().get$Point(), $.$$index(t1.$index(popupOptions, "offset"), 0), $.$$index(t1.$index(popupOptions, "offset"), 1), $, $);
    latlng = $.context().get$L().get$LatLng();
    t2 = this.popupOrigin_1;
    origin = $.Proxy_Proxy(latlng, t2.get$latitude(), t2.get$longitude(), $, $);
    t1.$indexSet(popupOptions, "offset", offsetPoint);
    popupOptions = $.Proxy_Proxy$_json(popupOptions);
    t1 = $.Proxy_Proxy($.context().get$L().get$Popup(), popupOptions, $, $, $);
    t3 = this.this_0;
    t3.set$_popup(t1);
...
$$.MapFeature_addTo_anon = {"": "Closure;this_0,map_1,featureLayer_2",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.featureLayer_2;
    t2 = this.map_1;
    ...
    if (t1 === true)
      ...
      t3.get$_mapFeature().addTo$1(t2.get$_liblib4$_map());
  }
};

$$.MapFeature_remove_anon = {"": "Closure;this_0,map_1,featureLayer_2",
  call$0: function() {
    var t1, t2, t3;
    t1 = this.featureLayer_2;
    t2 = this.map_1;
    t3 = this.this_0;
    if (t1 === true)
      t2.get$_featureLayerGroup().removeLayer$1(t3.get$_mapFeature());
    else
      $.remove(t2.get$_liblib4$_map(), t3.get$_mapFeature());
  }
};

$$.OpenStreetMap_loadMap_anon = {"": "Closure;this_0,tileURL_1,osmAttrib_2,subDomains_3",
  call$0: function() {
    var mapOptions, t1, t2, t3, osm, mouseOptions, t4;
    mapOptions = $.Proxy_Proxy$_json($.makeLiteralMap(["maxZoom", 18, "attribution", this.osmAttrib_2, "subdomains", this.subDomains_3]));
    t1 = $.context().get$L().get$Map();
    t2 = this.this_0;
    t2.set$_liblib4$_map($.Proxy_Proxy(t1, t2.get$_elementid(), $, $, $));
    t2.set$_featureLayerGroup($.Proxy_Proxy($.context().get$L().get$LayerGroup(), $, $, $, $));
    t2.get$_liblib4$_map().addLayer$1(t2.get$_featureLayerGroup());
    t3 = t2.get$_featureLayerGroup();
    $._jsGlobalize.callSync$1($._serialize(t3));
    osm = $.Proxy_Proxy($.context().get$L().get$TileLayer(), this.tileURL_1, mapOptions, $, $);
    t2.get$_liblib4$_map().addLayer$1(osm);
    mouseOptions = $.Proxy_Proxy$_json($.makeLiteralMap(["numDigits", 5]));
    $.Proxy_Proxy($.context().get$L().get$Control().get$MousePosition(), mouseOptions, $, $, $).addTo$1(t2.get$_liblib4$_map());
    t2.get$_liblib4$_map().setView$2($.Proxy_Proxy($.context().get$L().get$LatLng(), t2.get$initialLat(), t2.get$initialLon(), $, $), t2.get$initialZoom());
    t4 = t2.get$_liblib4$_map();
    $._jsGlobalize.callSync$1($._serialize(t4));
    t2.get$_liblib4$_map().on$2("moveend", $.Callback$many(t2.get$moveendHandler()));
  }
};
...
$$.OpenStreetMap_getBounds_anon = {"": "Closure;box_0,this_1",
  call$0: function() {
    var t1, south, t2;
    t1 = this.this_1;
    south = t1.get$_liblib4$_map().getBounds$0().getSouthWest$0().get$lat();
    t2 = this.box_0;
    t2.south_0 = south;
    t2.west_1 = t1.get$_liblib4$_map().getBounds$0().getSouthWest$0().get$lng();
    t2.north_2 = t1.get$_liblib4$_map().getBounds$0().getNorthEast$0().get$lat();
    t2.east_3 = t1.get$_liblib4$_map().getBounds$0().getNorthEast$0().get$lng();
  }
};

$$.OpenStreetMap_zoomTo_anon = {"": "Closure;this_0,zoom_1",
  call$0: function() {
    this.this_0.get$_liblib4$_map().zoomTo$1(this.zoom_1);
  }
};
...
$$.OpenStreetMap_getZoom_anon = {"": "Closure;this_0",
  call$0: function() {
    var t1 = this.this_0;
    t1.set$_zoom(t1.get$_liblib4$_map().getZoom$0());
  }
};
...
$$.OpenStreetMap_closePopup_anon = {"": "Closure;this_0",
  call$0: function() {
    this.this_0.get$_liblib4$_map().closePopup$0();
  }
};
...
$$._NativeJsSendPort_send_anon = {"": "Closure;this_1,message_2,replyTo_3",
  call$0: function() {
    ...
    isolate = $.$$index($globalState.isolates, t2.get$_liblib5$_isolateId());
    if (isolate == null)
      return;
    if (t2.get$_liblib5$_receivePort().get$_liblib5$_callback() == null)
      return;
    shouldSerialize = !($globalState.currentContext == null) && $.$$eq($globalState.currentContext.get$id(), t2.get$_liblib5$_isolateId()) !== true;
    msg = this.message_2;
    t1.msg_0 = msg;
    t1.reply_1 = t3;
    if (shouldSerialize) {
...
$$.Bound_open_HttpRequest = {"": "Closure;self,target",
...
$$.Bound_open_IdbFactory = {"": "Closure;self,target",
  call$2: function(p0, p1) {
    return this.self[this.target](p0, p1);
  },
...
$.initMap = function() {
  ...
  height = $.toString(window.innerHeight);
  width = $.toString(window.innerWidth);
  height0 = $.S(height) + " px";
  width0 = $.S(width) + " px";
...
$.initWebSocket = function(retrySeconds) {
  ...
  $.add($.socket.get$on().get$open(), new $.initWebSocket_anon());
  $.add($.socket.get$on().get$close(), new $.initWebSocket_anon0(retrySeconds));
  $.add($.socket.get$on().get$message(), new $.initWebSocket_anon1());
  $.add($.socket.get$on().get$error(), new $.initWebSocket_anon2(retrySeconds));
};

$.processVesselsInBounds = function(jsonArray) {
  var currentZoom, t1, t2;
  currentZoom = $.leaflet_map.getZoom$0();
  if (typeof currentZoom !== "number")
    return $.processVesselsInBounds$bailout(1, jsonArray, currentZoom);
  $.forEach($.get$vessels(), new $.processVesselsInBounds_anon());
  $.clear($.get$vessels());
  $.leaflet_map.clearFeatureLayer$0();
  for (t1 = $.iterator(jsonArray); t1.moveNext$0() === true;) {
    t2 = t1.get$current();
  ...
  if (currentZoom < 13) {
    ...
    document.query$1("#zoomSpeed").set$text(t1);
    document.query$1("#zoomSpeed").get$style().set$display("block");
  } else
    document.query$1("#zoomSpeed").get$style().set$display("none");
};
...
$.processVesselPositionEvent = function(json) {
  ...
  $.DateTime$_now().millisecondsSinceEpoch;
  t1 = $.getInterceptor$JSArrayJSString(json);
  vessel = $.$$index($.get$vessels(), $.toString(t1.$index(json, "userid")));
  if (vessel == null) {
    vessel = $.makeLiteralMap([]);
    vessel.$indexSet("mmsi", t1.$index(json, "userid"));
  }
  t2 = $.getInterceptor$JSArray(vessel);
  t2.$indexSet(vessel, "msgid", t1.$index(json, "msgid"));
  t2.$indexSet(vessel, "time_received", t1.$index(json, "time_received"));
  t2.$indexSet(vessel, "cog", t1.$index(json, "cog"));
  t2.$indexSet(vessel, "sog", t1.$index(json, "sog"));
  t2.$indexSet(vessel, "pos", t1.$index(json, "pos"));
  t2.$indexSet(vessel, "true_heading", t1.$index(json, "true_heading"));
  if (!(t2.$index(vessel, "vector") == null)) {
    t2.$index(vessel, "vector").remove$2($.leaflet_map, true);
    t2.remove$1(vessel, "vector");
  }
  if (!(t2.$index(vessel, "polygon") == null)) {
    t2.$index(vessel, "polygon").stopAnimation$0();
    t2.$index(vessel, "polygon").remove$2($.leaflet_map, true);
    t2.remove$1(vessel, "polygon");
  }
  if (!(t2.$index(vessel, "triangle") == null)) {
    t2.$index(vessel, "triangle").stopAnimation$0();
    t2.$index(vessel, "triangle").remove$2($.leaflet_map, true);
    t2.remove$1(vessel, "triangle");
  }
  $.paintToMap(vessel, new $.processVesselPositionEvent_anon(json));
};

$.onMouseoverHandler = function(e, mmsi) {
  var vessel, pos, t1, latlong, popupOptions;
  vessel = $.$$index($.get$vessels(), $.S(mmsi));
  pos = $.$$index(vessel, "pos");
  t1 = $.getInterceptor$JSArrayJSString(pos);
  latlong = $.Coord$(t1.$index(pos, 1), t1.$index(pos, 0));
...
$.paintToMap = function(v, callback) {
  var t1, moving, t2, shipStatics, cos_angle, sin_angle, vectorLength, vectorWidth, vectorPoints, shipPoint, circleOptions, iconOptions, icon;
  t1 = $.getInterceptor$JSArrayJSString(v);
  if (!(t1.$index(v, "pos") == null)) {
    $.DateTime$_now().millisecondsSinceEpoch;
    if (v.containsKey$1("ship_type") !== true)
      t1.$indexSet(v, "ship_type", 56);
    if ($.$$lt(t1.$index(v, "msgid"), 4) === true || $.$$eq(t1.$index(v, "msgid"), 5) === true) {
      moving = !(t1.$index(v, "sog") == null) && $.$$gt(t1.$index(v, "sog"), 0.4) === true && $.$$eq(t1.$index(v, "sog"), 102.3) !== true;
      if ($.$$gt($.leaflet_map.getZoom$0(), 11) === true) {
        if (t1.$index(v, "cog") == null)
          t2 = !(t1.$index(v, "true_heading") == null) && $.$$eq(t1.$index(v, "true_heading"), 0) !== true && $.$$eq(t1.$index(v, "true_heading"), 511) !== true;
        else
          t2 = true;
        shipStatics = t2 && !(t1.$index(v, "dim_port") == null) && !(t1.$index(v, "dim_stern") == null);
      } else
        shipStatics = false;
      t1.$indexSet(v, "angle", $.calcAngle(v));
      cos_angle = Math.cos($.checkNum(t1.$index(v, "angle")));
      sin_angle = Math.sin($.checkNum(t1.$index(v, "angle")));
      vectorLength = $.$$gt(t1.$index(v, "sog"), 30) === true ? $.$$div(t1.$index(v, "sog"), 10) : t1.$index(v, "sog");
      vectorWidth = $.$$gt(t1.$index(v, "sog"), 30) === true ? 5 : 2;
      vectorPoints = $.List_List(0, null);
      $.setRuntimeTypeInfo(vectorPoints, []);
      shipPoint = $.Coord$($.$$index(t1.$index(v, "pos"), 1), $.$$index(t1.$index(v, "pos"), 0));
      vectorPoints.push(shipPoint);
      if (moving) {
        vectorPoints.push(shipPoint);
        vectorPoints.push(shipPoint);
        vectorPoints.push($.calcVector($.$$index(t1.$index(v, "pos"), 0), $.$$index(t1.$index(v, "pos"), 1), vectorLength, sin_angle, cos_angle));
        t1.$indexSet(v, "vector", $.Polyline$(vectorPoints, $.makeLiteralMap(["color", "red", "weight", vectorWidth])));
        $.DateTime$_now().millisecondsSinceEpoch;
        t1.$index(v, "vector").addTo$2($.leaflet_map, true);
        $.DateTime$_now().millisecondsSinceEpoch;
        if (shipStatics) {
          t1.$indexSet(v, "polygon", $.AnimatedPolygon$(vectorPoints, $.makeLiteralMap(["autoStart", false, "animation", true, "distance", $.$$div(vectorLength, 10), "interval", 200, "dim_stern", t1.$index(v, "dim_stern"), "dim_port", t1.$index(v, "dim_port"), "dim_bow", t1.$index(v, "dim_bow"), "dim_starboard", t1.$index(v, "dim_starboard"), "angle", t1.$index(v, "angle"), "color", "blue", "weight", 3, "fill", true, "fillColor", $.$$index($.get$shipTypeColors(), t1.$index(v, "ship_type")), "fillOpacity", 0.6, "clickable", false]), t1.$index(v, "mmsi")));
          $.DateTime$_now().millisecondsSinceEpoch;
          t1.$index(v, "polygon").addTo$2($.leaflet_map, true);
          $.DateTime$_now().millisecondsSinceEpoch;
        }
        t1.$indexSet(v, "triangle", $.AnimatedPolygon$(vectorPoints, $.makeLiteralMap(["autoStart", false, "animation", true, "distance", $.$$div(vectorLength, 10), "interval", 200, "angle", t1.$index(v, "angle"), "zoom", $.leaflet_map.getZoom$0(), "color", "black", "weight", 1, "fill", true, "fillColor", $.$$index($.get$shipTypeColors(), t1.$index(v, "ship_type")), "fillOpacity", 0.8, "clickable", true]), t1.$index(v, "mmsi")));
        $.DateTime$_now().millisecondsSinceEpoch;
        t1.$index(v, "triangle").addTo$2($.leaflet_map, true);
        $.DateTime$_now().millisecondsSinceEpoch;
      } else {
        if (shipStatics) {
          t1.$indexSet(v, "polygon", $.AnimatedPolygon$(vectorPoints, $.makeLiteralMap(["autoStart", false, "animation", false, "distance", $.$$div(vectorLength, 10), "interval", 200, "dim_stern", t1.$index(v, "dim_stern"), "dim_port", t1.$index(v, "dim_port"), "dim_bow", t1.$index(v, "dim_bow"), "dim_starboard", t1.$index(v, "dim_starboard"), "angle", t1.$index(v, "angle"), "color", "blue", "weight", 3, "fill", true, "fillColor", $.$$index($.get$shipTypeColors(), t1.$index(v, "ship_type")), "fillOpacity", 0.6, "clickable", false]), t1.$index(v, "mmsi")));
          $.DateTime$_now().millisecondsSinceEpoch;
          t1.$index(v, "polygon").addTo$2($.leaflet_map, true);
          $.DateTime$_now().millisecondsSinceEpoch;
        }
        circleOptions = $.makeLiteralMap(["radius", 4, "fill", true, "fillColor", $.$$index($.get$shipTypeColors(), t1.$index(v, "ship_type")), "fillOpacity", 0.8, "color", "#000000", "strokeOpacity", 1, "strokeWidth", 0.5]);
        if (0 >= vectorPoints.length)
          throw $.ioore(0);
        t1.$indexSet(v, "marker", $.CircleMarker$(vectorPoints[0], circleOptions, t1.$index(v, "mmsi")));
        $.DateTime$_now().millisecondsSinceEpoch;
        t1.$index(v, "marker").addTo$2($.leaflet_map, true);
        $.DateTime$_now().millisecondsSinceEpoch;
      }
    } else {
      iconOptions = $.chooseIconOptions(v);
      icon = $.Icon$(iconOptions.$index("iconUrl"), iconOptions.$index("iconSize"));
      t1.$indexSet(v, "marker", $.Marker$($.$$index(t1.$index(v, "pos"), 1), $.$$index(t1.$index(v, "pos"), 0), t1.$index(v, "name"), false));
      t1.$index(v, "marker").setIcon$1(icon);
      t1.$index(v, "marker").addTo$2($.leaflet_map, true);
    }
    callback.call$1(v);
  }
...
$.chooseIconOptions = function(obj) {
  ...
  t1 = $.getInterceptor$JSArrayJSString(obj);
  if ($.$$eq(t1.$index(obj, "msgid"), 21) === true)
    return $.makeLiteralMap(["iconUrl", "images/atons/aton_" + $.S(t1.$index(obj, "aton_type")) + ".png", "iconSize", $.Dimension$(zoom, zoom)]);
  else if ($.$$eq(t1.$index(obj, "msgid"), 4) === true) {
    t1 = $.getInterceptor$JSNumber(zoom);
    return $.makeLiteralMap(["iconUrl", "images/baseStation.png", "iconSize", $.Dimension$(t1.$sub(zoom, 1), t1.$sub(zoom, 1))]);
  } else if ($.$$eq(t1.$index(obj, "msgid"), 9) === true) {
    if (typeof zoom !== "number")
      throw $.iae(zoom);
    t1 = 3 * zoom;
    return $.makeLiteralMap(["iconUrl", "images/helicopter.png", "iconSize", $.Dimension$(t1, t1)]);
  } else
    return $.makeLiteralMap(["iconUrl", "http://images.vesseltracker.com/images/googlemaps/icon_lastpos.png", "iconSize", $.Dimension$(6 + 2 * Math.log($.checkNum(zoom)), 6 + 2 * Math.log($.checkNum(zoom)))]);
};

$.createMouseOverPopup = function(vessel) {
  var t1, mouseOverPopup, timeString, mouseOverPopup0;
  t1 = $.getInterceptor$JSArrayJSString(vessel);
  if ($.$$eq(t1.$index(vessel, "msgid"), 21) === true) {
    mouseOverPopup = (!(t1.$index(vessel, "name") == null) ? "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>" + $.S(t1.$index(vessel, "name")) + "</b></nobr></td></tr>" : "<div class='mouseOverPopup'><table>") + "<tr><td>MMSI: &nbsp;</td><td><nobr>" + $.S($.toString(t1.$index(vessel, "mmsi"))) + "</nobr></td></tr>";
    if (!(t1.$index(vessel, "aton_type") == null))
      mouseOverPopup = mouseOverPopup + "<tr><td colspan='2'><b>" + $.S($.$$index($.get$aton_types(), t1.$index(vessel, "aton_type"))) + "</b></nobr></td></tr>";
  } else if ($.$$eq(t1.$index(vessel, "msgid"), 4) === true)
    mouseOverPopup = (t1.$index(vessel, "name") === true ? "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>AIS Base Station</b></nobr></td></tr><tr><td colspan='2'><b>" + $.S(t1.$index(vessel, "name")) + "</b></nobr></td></tr>" : "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>AIS Base Station</b></nobr></td></tr>") + "<tr><td>MMSI: &nbsp;</td><td><nobr>" + $.S($.toString(t1.$index(vessel, "mmsi"))) + "</nobr></td></tr>";
  else if ($.$$eq(t1.$index(vessel, "msgid"), 9) === true) {
    mouseOverPopup = (t1.$index(vessel, "name") === true ? "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>Helicopter SAR</b></nobr></td></tr><tr><td colspan='2'><b>" + $.S(t1.$index(vessel, "name")) + "</b></nobr></td></tr>" : "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>Helicopter SAR</b></nobr></td></tr>") + "<tr><td>MMSI: &nbsp;</td><td><nobr>" + $.S($.toString(t1.$index(vessel, "mmsi"))) + "</nobr></td></tr>";
    if (t1.$index(vessel, "altitude") === true)
      mouseOverPopup = mouseOverPopup + "<tr><td>Altitude: &nbsp;</td><td><nobr>" + $.S($.toString(t1.$index(vessel, "altitude"))) + "</nobr></td></tr>";
  } else {
    mouseOverPopup = !(t1.$index(vessel, "name") == null) ? "<div class='mouseOverPopup'><table><tr><td colspan='2'><b>" + $.S(t1.$index(vessel, "name")) + "</b></nobr></td></tr>" : "<div class='mouseOverPopup'><table>";
    mouseOverPopup = (!(t1.$index(vessel, "imo") == null) ? mouseOverPopup + "<tr><td>IMO</td><td>" + $.S(t1.$index(vessel, "imo")) + "</b></nobr></td></tr>" : mouseOverPopup) + "<tr><td>MMSI: &nbsp;</td><td><nobr>" + $.S($.toString(t1.$index(vessel, "mmsi"))) + "</nobr></td></tr>";
    if (!(t1.$index(vessel, "nav_status") == null) && $.$$lt(t1.$index(vessel, "nav_status"), 15) === true && $.$$gt(t1.$index(vessel, "nav_status"), -1) === true)
      mouseOverPopup = mouseOverPopup + "<tr><td>NavStatus: &nbsp;</td><td><nobr>" + $.S($.$$index($.get$nav_stati(), t1.$index(vessel, "nav_status"))) + "</nobr></td></tr>";
    if (!(t1.$index(vessel, "sog") == null))
      mouseOverPopup = mouseOverPopup + "<tr><td>Speed: &nbsp;</td><td><nobr>" + $.S($.toString(t1.$index(vessel, "sog"))) + "</nobr></td></tr>";
    if (!(t1.$index(vessel, "true_heading") == null) && $.$$eq(t1.$index(vessel, "true_heading"), 511) !== true)
      mouseOverPopup = mouseOverPopup + "<tr><td>Heading: &nbsp;</td><td><nobr>" + $.S($.toString(t1.$index(vessel, "true_heading"))) + "</nobr></td></tr>";
    if (!(t1.$index(vessel, "cog") == null))
      mouseOverPopup = mouseOverPopup + "<tr><td>Course: &nbsp;</td><td><nobr>" + $.S($.toString(t1.$index(vessel, "cog"))) + "</nobr></td></tr>";
    timeString = $.substring($.DateTime$fromMillisecondsSinceEpoch(t1.$index(vessel, "time_received"), false).toString$0(), 0, 16);
    mouseOverPopup0 = mouseOverPopup + "<tr><td>TimeReceived: &nbsp;</td><td><nobr>" + $.S(timeString) + "</nobr></td></tr>";
    ...
    if (!(t1.$index(vessel, "draught") == null))
      mouseOverPopup = mouseOverPopup + "<tr><td>draught</td><td>" + $.S($.toString($.$$div(t1.$index(vessel, "draught"), 10))) + "</b></nobr></td></tr>";
    if (!(t1.$index(vessel, "dim_bow") == null) && !(t1.$index(vessel, "dim_port") == null))
      mouseOverPopup = mouseOverPopup + "<tr><td>length, width</td><td>" + $.S($.toString($.$$add(t1.$index(vessel, "dim_stern"), t1.$index(vessel, "dim_bow")))) + "," + $.S($.toString($.$$add(t1.$index(vessel, "dim_starboard"), t1.$index(vessel, "dim_port")))) + "</b></nobr></td></tr>";
    if (!($.$$index($.get$shipTypes(), t1.$index(vessel, "ship_type")) == null))
      mouseOverPopup = mouseOverPopup + "<tr><td>ship_type</td><td>" + $.S($.$$index($.get$shipTypes(), t1.$index(vessel, "ship_type"))) + "</b></nobr></td></tr>";
    if (!(t1.$index(vessel, "rot") == null))
      mouseOverPopup = mouseOverPopup + "<tr><td>Rotation</td><td>" + $.S($.toString(t1.$index(vessel, "rot"))) + "</b></nobr></td></tr>";
  }
  return mouseOverPopup + "</table></div>";
};

$.calcAngle = function(vessel) {
  var t1, hdg, cog, sog, direction;
  t1 = $.getInterceptor$JSArrayJSString(vessel);
  hdg = t1.$index(vessel, "true_heading");
  cog = t1.$index(vessel, "cog");
  $.$$index(t1.$index(vessel, "pos"), 0);
  $.$$index(t1.$index(vessel, "pos"), 1);
  sog = t1.$index(vessel, "sog");
  direction = $.$$eq(t1.$index(vessel, "mmsi"), 211855000) === true ? 299 : 0;
  if (!(sog == null) && $.$$gt(sog, 0.4) === true && $.$$lt(cog, 360) === true)
    direction = cog;
  else {
    t1 = $.getInterceptor(hdg);
    if (!(hdg == null) && t1.$gt(hdg, 0) === true && t1.$eq(hdg, 511) !== true && t1.$lt(hdg, 360) === true)
      direction = hdg;
  }
  return $.$$mul($.$$negate(direction), 0.017453292519943295);
};

$.calcVector = function(lon, lat, sog, sinus, cosinus) {
  var t1, dy_deg, t2, dx_deg;
  t1 = $.getInterceptor$JSNumber(sog);
  dy_deg = $.$$div($.$$negate(t1.$mul(sog, cosinus)), 10000);
  t2 = $.getInterceptor$JSNumber(lat);
  dx_deg = $.$$div($.$$div($.$$negate($.$$mul(t1.$negate(sog), sinus)), Math.cos($.checkNum(t2.$mul(lat, 0.017453292519943295)))), 10000);
  return $.Coord$(t2.$sub(lat, dy_deg), $.$$sub(lon, dx_deg));
};
...
$.joinArguments$bailout = function(state0, types, startIndex) {
  ...
  buffer = $.JsStringBuffer$("");
  for (t1 = $.getInterceptor$JSArrayJSString(types), index = startIndex, firstArgument = true; $.CONSTANT5.$lt(index, t1.get$length(types)); ++index) {
    if (firstArgument)
      firstArgument = false;
    else
      buffer.add$1(", ");
...
$.Arrays_copy$bailout = function(state0, src, srcStart, dst, dstStart, count) {
  ...
  if (srcStart < dstStart)
    for (i = srcStart + count - 1, j = dstStart + count - 1; i >= srcStart; --i, --j) {
      if (i < 0 || i >= src.length)
        throw $.ioore(i);
      $.CONSTANT3.$indexSet(dst, j, src[i]);
    }
  else
...
$.IterableMixinWorkaround_removeAll = function(collection, elementsToRemove) {
  var t1, t2;
  for (t1 = $.CONSTANT3.get$iterator(elementsToRemove), t2 = $.getInterceptor$JSArray(collection); t1.moveNext$0() === true;)
    t2.remove$1(collection, t1.get$current());
};

$.IterableMixinWorkaround_removeAllList = function(collection, elementsToRemove) {
  $.removeMatching(collection, $.contains0($.CONSTANT3.toSet$0(elementsToRemove)));
};
...
$.IterableMixinWorkaround_mappedByList = function(list, f) {
  return $.MappedList$(list, f, null, null);
};
...
$.HashSet_HashSet$from = function(other, E) {
  var set, t1;
  set = $.HashSet$(E);
  for (t1 = $.CONSTANT3.get$iterator(other); t1.moveNext$0() === true;)
...
$.Proxy_Proxy$withArgList = function($constructor, $arguments) {
  ...
  t1 = [$constructor];
  $.CONSTANT3.addAll$1(t1, $arguments);
  serialized = $.toList($.CONSTANT3.mappedBy$1(t1, $._serialize));
...
$.$defineNativeClass("XMLHttpRequest", {
  ...
  get$open: function() {
    return new $.Bound_open_HttpRequest(this, "open$5");
  },
  $$dom_removeEventListener$3: function(type, listener, useCapture) {
    return this.removeEventListener(type,$.convertDartClosureToJS(listener, 1),useCapture);
  },
...
$.$defineNativeClass("IDBFactory", {
  ...
  get$open: function() {
    return new $.Bound_open_IdbFactory(this, "open$2");
  }
});
